...
app = Flask(__name__)
app.secret_key = 'amu_final_secret_key'
...
with app.app_context():
    ...
    if not Question.query.first():
        qs = [
            ...
            Question(text="What is the full form of LAN?", option_a="Local Area Net", option_b="Local Access Network", option_c="Local Area Network", option_d="Large Area Network", correct_answer="C"),
            ...
            Question(text="What is a MAC address size?", option_a="32 bits", option_b="48 bits", option_c="64 bits", option_d="128 bits", correct_answer="B"),
